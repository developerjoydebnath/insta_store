...
const FavouriteIcon = ({ height, width, className = '' }) => {
    return (
        <div className="relative">
            ...
            <span className="w-4 max-w-5xl h-4 absolute text-white text-[10px] -top-2 bg-red-500 -right-0 flex items-center justify-center rounded-r-full rounded-l-full px-1">
                45
            </span>
        </div>
    );
